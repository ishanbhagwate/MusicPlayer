...
import com.shivam.musicplayer.StorageUtils;
...
import static com.shivam.musicplayer.PlayerActivity.Broadcast_PLAY_NEW_AUDIO;
...
public class AllSongsFragment extends Fragment {
    ...
    public void onViewCreated( View view,  Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.allSongsRecyclerView_id);
        context = getActivity();
        cardView = view.findViewById(R.id.allslidingPanelLayout_id);
...
//        recyclerView.setAdapter(new SongsAdapter(songsList));
    ...
    private void playAudio(int audioIndex) {
        ...
        if (!serviceBound) {
            ...
            StorageUtils storage = new StorageUtils(getActivity());
...
//                songsList.add(new Songs(thisId,thisTitle,thisArtist,thisPath));
            }
